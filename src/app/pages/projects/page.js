...
export default function Projects() {
  return (
    <main className="">
      <div className="flex flex-wrap mt-8 mb-16 sm:mt-12 md:mx-32 justify-center items-center text-center gap-8 w-fit text-neutral-600 animate-slidein opacity-0 [--slidein-delay:200ms]">
        <Project
